...
const CompararPerplejidad = () => {
    ...
    if (!loaded1) {
        fetch(`http://localhost:5000/colecciones/${index}/${coleccionComparar}/perplejidad`)
            ...
            .then(data => {
                ...
                setValorPerplejidad1(procesarAtributo(data.valor_perplejidad));
                setLoaded1(true);
            })
    ...
    const DatosTabla = [
        CrearValoresTabla('Perplejidad', valorPerplejidad1),
    ];
...
export default CompararPerplejidad;