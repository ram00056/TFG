...
const AnalisisLIWC = () => {
    ...
    const [valorLIWC, setValorLIWC] = useState('');
    const [loaded2, setLoaded2] = useState(false);

    if (!loaded2) {
        fetch(`http://localhost:5000/colecciones/${index}/VerLIWC`)
            .then(response => response.json())
            .then(data => {
                setNombre(data.nombre_c);
                setValorLIWC(data.valor_liwc);
                setLoaded2(true);
            })
    ...
    const toCSV = () => {
        ...
        // Datos de la característica "LIWC"
        const data = {
            valorLIWC: getFormattedValues(valorLIWC) // Suponiendo que 'bdlase' es una variable que contiene todos los valores
        };
        ...
        link.setAttribute('download', 'LIWC.csv');
    ...
    return (
        <div style={{ textAlign: 'center', padding: '20px' }}>
            ...
            <h1 style={{ textAlign: 'left', marginLeft: '50px', textDecoration: 'underline' }}>LIWC</h1>
            ...
            <div style={{
                ...
                <h3 style={{ fontSize: '20px' }}>Resumen para la Característica "LIWC"</h3>
                <div style={{ textAlign: 'center', margin: '20px auto', width: '80%' }}>
                    <table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid #ccc' }}>
                        <tbody>
                            ...
                            <tr>
                                <td style={{ padding: '10px', borderRight: '1px solid #ccc', fontWeight: 'bold' }}>LIWC</td>
